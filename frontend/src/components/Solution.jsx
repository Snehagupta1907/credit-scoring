    ...
    <section id="solution" className="py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6" ref={ref}>
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              <span className="text-blue-400">💡</span> Our Solution: The First On-Chain Credit Scoring System
            </h2>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          >
            <h3 className="text-2xl font-bold mb-6 text-blue-400">How it works:</h3>
            ...
            <div className="mt-8 space-y-3">
              <h3 className="text-xl font-bold text-blue-400">Example Use Cases:</h3>
                ...
                <div className="space-y-4">
                  <div className="bg-black-700/30 rounded-lg p-4">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-2xl font-bold text-blue-400">785</span>
                    </div>
                    <div className="w-full bg-black-700 rounded-full h-2">
                      <div className="bg-gradient-to-r from-blue-500 to-purple-500 h-2 rounded-full" style={{ width: '78.5%' }}></div>
                    </div>
                  </div>
