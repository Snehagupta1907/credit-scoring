...
export default function Footer() {
  return (
    <footer className="bg-black-800/50">
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Revolutionizing DeFi lending through decentralized credit scoring.
            </p>
          ...
          <div>
            <h3 className="text-lg font-semibold text-white bg mb-4">Products</h3>
            <ul className="space-y-2">
              <li><Link href="/credit-score" className="text-gray-400 hover:text-white transition-colors">Credit Score</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">© 2025 DeFi Credit Score. All rights reserved.</p>
