      ...
      <div className="container mx-auto px-4 md:px-6" ref={ref}>
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            <span className="text-blue-400">📅</span> Roadmap to Success
          </h2>
        ...
        <div className="relative">
          {/* Vertical line */}
          <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-600 via-purple-600 to-blue-600 transform -translate-x-1/2"></div>
          ...
          <div className="space-y-12">
            ...
            >
              <div className="w-full md:w-1/2 md:pr-12 md:text-right mb-6 md:mb-0">
                <div className="bg-gradient-to-r from-blue-600 to-green-600 inline-block px-4 py-2 rounded-lg font-bold mb-4">
                  Current Phase (MVP)
                </div>
              ...
              <div className="relative flex md:justify-center">
                <div className="h-8 w-8 bg-blue-600 rounded-full flex items-center justify-center relative z-10">
            ...
            >
              ...
              <div className="relative flex md:justify-center">
                <div className="h-8 w-8 bg-purple-600 rounded-full flex items-center justify-center relative z-10">
                  <div className="h-3 w-3 bg-white rounded-full"></div>
                </div>
              </div>
              <div className="w-full md:w-1/2 md:pl-12 mb-6 md:mb-0">
                <div className="bg-gradient-to-r from-purple-600 to-blue-600 inline-block px-4 py-2 rounded-lg font-bold mb-4">
                  Phase 2 (3 Months)
                </div>
            ...
            >
              <div className="w-full md:w-1/2 md:pr-12 md:text-right mb-6 md:mb-0">
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 inline-block px-4 py-2 rounded-lg font-bold mb-4">
                  Phase 3 (6-12 Months)
                </div>
